...
public class DiamondActivity extends AppCompatActivity {
    ...
    TextView textTimerView,diamondPushUPResult,caloriesBurnedTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        diamondPushUPResult = findViewById(R.id.diamoundPushUpResult);
...
//                startActivity(new Intent(DiamondActivity.this, WorkoutActivity.class));
//                finish();
            }
        };
