...
public class HickingActivity extends AppCompatActivity {
    private static final int LOCATION_PERMISSION_REQUEST_CODE = 1;
    private TextView timerTextView;
    private CountDownTimer countDownTimer;
    private boolean isRunning = false;
    private long remainingTime;
    private TextView HickingActivityResult;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hicking);

        long duration = TimeUnit.MINUTES.toMillis(30);
        timerTextView = findViewById(R.id.timerTextView);
        Button startButton = findViewById(R.id.startButton);
        HickingActivityResult = findViewById(R.id.HickingActivityResult);

        //Inisilization Location Service
        ...
        countDownTimer = new CountDownTimer(duration, 1000) {
            ...
            public void onFinish() {
                ...
                HickingActivityResult.setText("Your Running Result Here");
                startActivity(new Intent(HickingActivity.this, WorkoutActivity.class));
                finish();
            }
        };
