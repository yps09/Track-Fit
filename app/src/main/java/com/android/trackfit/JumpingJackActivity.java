...
public class JumpingJackActivity extends AppCompatActivity {
    ...
    TextView textTimerView, jumpTxtResult,caloriesBurnedTextView;
    Button startButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jumpTxtResult = findViewById(R.id.jumpTxtResult);
        ...
        countDownTimer = new CountDownTimer(duration, 1000) {
            ...
            public void onFinish() {
                ...
                startActivity(new Intent(JumpingJackActivity.this, WorkoutActivity.class));
                finish();
            }
        };
