...
public class OutdoorFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button running = view.findViewById(R.id.Runningbtn);
        Button cycling = view.findViewById(R.id.Cyclingbtn);
        Button yoga  = view.findViewById(R.id.yogabtn);
        Button trailRunning = view.findViewById(R.id.Trailrunningbtn);
        Button  hiking = view.findViewById(R.id.hickingbtn);

        // setOnClickLisner for Running activity
        ...
        trailRunning.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(),TrailRuningActivity.class);
                startActivity(intent);
            }
        });
        ...
        hiking.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(),HickingActivity.class);
                startActivity(intent);
            }
        });
