...
public class PushUpActivity extends AppCompatActivity {
    ...
    TextView textTimerView,pushUpResult,caloriesBurnedTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pushUpResult = findViewById(R.id.pushUpResult);
...
//                startActivity(new Intent(PushUpActivity.this, WorkoutActivity.class));
//                finish();
            }
        };
