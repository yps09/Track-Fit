...
public class SquatActivity extends AppCompatActivity {
    ...
    TextView textTimerView,squadTxtResult,caloriesBurnedTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        squadTxtResult = findViewById(R.id.squadResultTxt);
        ...
        countDownTimer = new CountDownTimer(duration, 1000) {
            ...
            public void onFinish() {
                ...
                //startActivity(new Intent(SquatActivity.this, WorkoutActivity.class));
                //finish();
            }
        };
