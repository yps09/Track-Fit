...
public class TrailRuningActivity extends AppCompatActivity {

    private  TextView timerTextView,TrailRunningActivityResultHeading;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trail_runing);

        long duration = TimeUnit.MINUTES.toMillis(30);
        timerTextView = findViewById(R.id.timerTextView);
        Button startButton = findViewById(R.id.startButton);
        TrailRunningActivityResultHeading = findViewById(R.id.TrailRunningActivityResultHeading);
        ...
        countDownTimer = new CountDownTimer(duration, 1000) {
            ...
            public void onFinish() {
                ...
                TrailRunningActivityResultHeading.setText("Your Running Result Here");
                startActivity(new Intent(TrailRuningActivity.this, WorkoutActivity.class));
                finish();
            }
        };
    ...
    private void updateDistanceUI(String distance){
        TextView distanceTextView =  findViewById(R.id.trailRunnindresult);
    ...
    private void startRunning() {
        if (remainingTime > 0) { 
            ...
            countDownTimer = new CountDownTimer(remainingTime, 1000) {
                ...
                public void onFinish() {
                    // Handle timer finish logic
                    TrailRunningActivityResultHeading.setText("Here is the Score of Your Trail Running Activity");
                    startActivity(new Intent(TrailRuningActivity.this, WorkoutActivity.class));
                    finish();
                }
            }.start();
